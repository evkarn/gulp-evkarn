// IMPORT READ-PROGRESS-CIRCLE
	// import { readProgressCircle } from './src/_utils/read-progress-circle/index.js';
// END. IMPORT READ-PROGRESS-CIRCLE


	// INIT READ-PROGRESS-CIRCLE
		// readProgressCircle();
...
export function readProgressCircle() {
	...
	circleAppend.innerHTML = '<svg viewBox="-10 -10 300 300"><circle class="circle-block__progress" r="140" cx="140" cy="140" fill="none" stroke-width="20"></circle></svg>';
