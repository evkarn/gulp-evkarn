// IMPORT LAZY-LOAD-MAP-GOOGLE
// import { lazyLoadGoogleMap } from './src/_utils/lazy-load/index.js';
// END. IMPORT LAZY-LOAD-MAP-GOOGLE


	// INIT LAZY-LOAD-MAP-GOOGLE
		// lazyLoadGoogleMap();
...
export function lazyLoadGoogleMap() {
	...
	function getMap() {
		...
		if (pageYOffset > loadMapBlockPos - windowHeight) {
			...
			if (loadMapUrl) { // Если атрибут "data-set" не пустой, то вставляем в блок с картой фрейм от google.ru/map
