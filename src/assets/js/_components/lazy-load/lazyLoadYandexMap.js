// IMPORT LAZY-LOAD-MAP-YANDEX
// import { lazyLoadYandexMap } from './src/_utils/lazy-load/index.js';
// END. IMPORT LAZY-LOAD-MAP-YANDEX


	// INIT LAZY-LOAD-MAP-YANDEX
		// lazyLoadYandexMap();
	// END. INIT LAZY-LOAD-MAP-YANDEX
