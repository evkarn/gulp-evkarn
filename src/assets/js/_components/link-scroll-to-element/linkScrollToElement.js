// IMPORT LINK-SCROLL-TO-ELEMENT
// import { linkScrollToElement } from './_components/index.js';
// END. IMPORT LINK-SCROLL-TO-ELEMENT


	// INIT LINK-SCROLL-TO-ELEMENT
		// if (document.querySelector('[data-nav-page]')) {
		// 	linkScrollToElement();
		// }
	// END. INIT LINK-SCROLL-TO-ELEMENT
	...
	if(linksScroll.length > 0) {
		...
		function onScrollLinkClick(e) {
			...
			if(dataSet && document.querySelector(dataSet)){
				...
				const targetElementValue = targetElement.getBoundingClientRect().top + pageYOffset - document.querySelector('header').offsetHeight;
